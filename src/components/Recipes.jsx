...
const Recipes = () => {
    ...
    return (
        <div className=" ">
            <h1 className="text-center text-orange-500 text-3xl font-semibold">OUR RECIPES</h1>
            <p className="text-center text-2xl font-semibold ">
            Discover a brand-new, street-level food with a twist, <br /> handcrafted with ingredients from the city's local markets.
            </p>
